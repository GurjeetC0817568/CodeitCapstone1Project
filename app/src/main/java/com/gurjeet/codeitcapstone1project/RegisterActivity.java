...
public class RegisterActivity extends AppCompatActivity {
    private TextInputLayout rname, remail, rpassword, rphone,raddress;
        ...
        rRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(rname.getEditText().getText().toString()) &&
                        !TextUtils.isEmpty(rphone.getEditText().getText().toString()) &&
                        !TextUtils.isEmpty(raddress.getEditText().getText().toString()) &&
                    ...
                    phone = rphone.getEditText().getText().toString().trim();
                    address = raddress.getEditText().getText().toString().trim();
                    createUserWithEmailAndPassword(name, email, password, phone, address);
                } else {
    ...
    private void createUserWithEmailAndPassword(final String name, final String email, final String password,final String phone,final String address) {
